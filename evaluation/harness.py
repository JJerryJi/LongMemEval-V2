...
def inject_runtime_memory_params(
    ...
    *,
    ...
    if runtime_config["memory_type"] in {"codex", "agentrunbook_c", "agentrunbook_c_openai_sdk"} and query_trace_dir is not None:
        ...
        if args.prompt_build_max_workers > 1:
            require(
                ...
                (
                    ...
                    "supported for rag, agentrunbook_r, codex, agentrunbook_c, and agentrunbook_c_openai_sdk"
                ),
            )
